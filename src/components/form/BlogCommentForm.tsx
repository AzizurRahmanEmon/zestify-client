    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setAlert({
          type: "success",
          message:
            json?.message || "Your comment has been submitted successfully!",
        });
    ...
    <>
      {!currentCustomer?.token ? (
        <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl text-center space-y-3">
          ...
          <Link
            href="/login"
            className="inline-flex items-center px-6 py-3 bg-zPink text-white rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold"
          >
            Log In
          </Link>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="relative">
              <input
                ...
                disabled={isSubmitting || !!currentCustomer?.token}
